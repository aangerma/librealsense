...
namespace librealsense
{
    ...
    unsigned int timestamp_composite_matcher::get_fps(const frame_holder & f)
    {
        ...
        std::stringstream s;
        s << "fps " << fps << " " << frame_to_string(const_cast<frame_holder&>(f));
    ...
    void timestamp_composite_matcher::update_next_expected(const frame_holder & f)
    {
        ...
        std::stringstream s;
        s << _name << frame_to_string(const_cast<frame_holder&>(f)) << "fps " << fps << " gap " << gap << " next_expected: " << _next_expected[matcher.get()];
    }
